    ...
    <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold  text-center p-3 mb-2 bg-info text-white">أدارة الغرف</h4>
                                ...
                                <table class="table table-bordered"  name='roomstable' id="roomstable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr  class="table-info text-center">
                                            <th>الأسم</th>
                                            <th>رقم الغرفة في شموس</th>
                                            <th>الطابق</th>
                                            <th>عدد الغرف</th>
                                            <th>عدد دورات المياة</th>
                                            <th>عدد الأسرة المفردة</th>
                                            <th>عدد الأسرة المزدوجة</th>
                                            <th>عدد الخزائن</th>
                                            <th>عدد التلفزيونات</th>
                                            <th>نوع المكيف</th>
                                            <th>نوع الغرفة</th>
                                            <th>ملاحظات</th>
