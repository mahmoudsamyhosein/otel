                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                <a href="#exampleModalCenter20"  data-toggle="modal" data-target="#exampleModal20" class="btn btn-info btn-sm">تعديل</a>
                                                    {!! Form::open(['method' => 'DELETE','route' => ['clients.destroy', $allclients->id],'style'=>'display:inline']) !!}
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                                    <form class="form" method="POST" action="{{ route('clients.create',$allclients->id ) }} " enctype="multipart/form-data" >
                                                        @csrf
                                                            <div class="form-row">
                        ...
                        <div class="modal fade" id="exampleModalCenter20" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle20" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                            <form action="{{route('clients.show',$allclients->id )}}" method="GET">
                                                @csrf
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                <td>نوع الأثبات</td>
                                                                <td>{{$allclients->approve_type}}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>رقم الأثبات</td>
                                                                <td>{{$allclients->approve_number}}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>مكان الأصدار</td>
                                                                <td>{{$allclients->place_of_issue}}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>تاريخ الأنتهاء</td>
                                                                <td>{{$allclients->date_of_expiry}}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>العنوان</td>
                                                                <td>{{$allclients->address}}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>جوال</td>
                                                                <td>{{$allclients->phone}}</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td>جهة العمل</td>
                                                                <td>{{$allclients->place_of_work}}</td>

                                                            </tr>
                                                            <tr>
                                                                <td>جوال العمل</td>
                                                                <td>{{$allclients->phone_of_work}}</td>
                     ...
                     {{-- programedbyMSHM                         --}}
                        ...
                        <div class="modal fade" id="exampleModal20" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel20" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form" method="POST" action="{{ route('clients.update', $allclients->id )}}" enctype="multipart/form-data" >
                                        @method('patch')
                                        @csrf
                                                <div class="form-row">
                                                        <div class="form-group col-lg-2 col-md-2">
                                                            <label for="name"><span>الاسم بالكامل</span> </label>
                                                            <input type="text" value="{{ $allclients->name }}" name='name' class="form-control" id="name" >
                                                        </div>
                                                        ...
                                                        <div class="form-group col-lg-2 col-md-2">
                                                            <label for="phone">رقم الجوال</label>
                                                            <input type="text" value='{{ $allclients->phone }}'  name='phone' class="form-control" id="phone" >
                                                        </div>
                                                        <div class="form-group col-lg-2 col-md-2">
                                                            <label for="approve_number">رقم الأثبات</label>
                                                            <input type="text" value='{{ $allclients->approve_number }}' name='approve_number' class="form-control" id="approve_number" >
                                                        </div>


                                                        <div class="form-group col-lg-2 col-md-2">
                                                            <label for="place_of_work">مكان العمل</label>
                                                            <input type="text" value='{{ $allclients->place_of_work }}' name='place_of_work' class="form-control" id="place_of_work">
                                                        </div>


                                                        <div class="form-group col-lg-2 col-md-2">
                                                            <label for="place_of_issue">مكان الأصدار</label>
                                                            <input type="text" value='{{ $allclients->place_of_issue }}' name='place_of_issue' class="form-control" id="place_of_issue">
                                                        </div>
                                                        <div class="form-group col-lg-2 col-md-2">
                                                            <label for="date_of_expiry">تاريخ الأنتهاء</label>
                                                            <input type="text"  id='datetimepicker5' value='{{ $allclients->date_of_expiry }}' name='date_of_expiry' class="form-control" id="date_of_expiry">
                                                        </div>


                                                        <div class="form-group col-lg-2 col-md-2">
                                                            <label for="phone_of_work">هاتف العمل</label>
                                                            <input type="text" value='{{ $allclients->phone_of_work }}' name='phone_of_work' class="form-control" id="phone_of_work" >
                                                        </div>

                                                        <div class="form-group col-lg-2 col-md-2">
                                                            <label for="date_of_birth">تاريخ الميلاد</label>
                                                            <input type="text" id='datetimepicker4' value='{{ $allclients->date_of_birth }}' name='date_of_birth' class="form-control" id="date_of_birth" >
                                                        ...
                                                        <div class="form-group col-lg-2 col-md-2">
                                                            ...
                                                            <textarea class="form-control" value='{{ $allclients->address }}'  name="address" id="address" rows="3"></textarea>
                                                        </div>

                                                        <div class="form-group col-lg-2 col-md-2">
                                                            <label  for="email">البريد الالكتروني</label>
                                                            <input type="email" value='{{ $allclients->email }}' name='email' class="form-control"  id="email">
                                                        </div>

                                                        <div class="form-group col-lg-2 col-md-2">
                                                            <label for="note">ملاحظات </label>
                                                            <textarea class="form-control"  value='{{ $allclients->note }}' name='note' id="note" rows="3"></textarea>
                                                        </div>

                                                        <div class="form-group col-lg-2 col-md-2">
                                                            <label for="note_2'">ملاحظات خاصة</label>
                                                            <textarea class="form-control"  value='{{ $allclients->note_2}}' name='note_2' id="note_2'" rows="3"></textarea>
                                                        </div>                                                    
                                                </div>
                                            </div>
